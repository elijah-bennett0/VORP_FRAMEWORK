Config = {
  ...
  HowAmountThirstWhileRunning = 0.75,     -- How much thirst decreases while running (value decreases every 3.6 seconds).
  HowAmountHungerWhileRunning = 0.75,     -- How much hunger decreases while running.
  HowAmountThirst = 0.5,                 -- How much thirst decreases while not running (idle state).
  HowAmountHunger = 0.5,                 -- How much hunger decreases while not running (idle state).
  HowAmountMetabolismWhileRunning = 0.75, -- How much metabolism decreases while running.
  HowAmountMetabolism = 0.5,             -- How much metabolism decreases while not running (idle state).
